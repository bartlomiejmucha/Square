...
$srcXConnectWDPZipPath = "$srcZipsPath\Sitecore 9.0.1 rev. 171219 (OnPrem)_xp0xconnect.scwdp.zip"
$srcSitecoreWDPZipPath = "$srcZipsPath\Sitecore 9.0.1 rev. 171219 (OnPrem)_single.scwdp.zip"
